...
NUM_CLASSES_cacd = 49
NUM_CLASSES_afad = 26
NUM_CLASSES = NUM_CLASSES_cacd
model = resnet34(NUM_CLASSES, GRAYSCALE) # creació del model
cacd = 'cacd_coral_basic/best_model.pt'
afad = 'afad-model1/best_model.pt'
model.load_state_dict(torch.load(cacd)) # load del model
