...
test.sample(n=1000,axis=0,random_state = 420).reset_index().to_csv('cacd_test_sample.csv')

valid = pd.read_csv('cacd_valid.csv')
valid.sample(n=1000,axis=0,random_state = 420).reset_index().to_csv('cacd_valid_sample.csv')
